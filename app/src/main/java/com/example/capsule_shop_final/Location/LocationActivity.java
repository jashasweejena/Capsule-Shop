...
package com.example.capsule_shop_final.Location;
...
public class LocationActivity extends AppCompatActivity {
    ...
    /**
     * Provides access to the Fused LocationModel Provider API.
     */
    private FusedLocationProviderClient mFusedLocationClient;

    /**
     * Provides access to the LocationModel Settings API.
     */
    ...
    /**
     * Callback for LocationModel events.
     */
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                Log.i(TAG, "LocationModel settings are not satisfied. Attempting to upgrade " +
                                        "location settings ");
                                try {
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                String errorMessage = "LocationModel settings are inadequate, and cannot be " +
